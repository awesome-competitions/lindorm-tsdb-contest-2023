...
public class OriginalStringCodec extends Codec<ByteBuffer[]>{

    private final int fixedSize;

    private final int maxSize;

    public OriginalStringCodec(int fixedSize) {
        this(fixedSize, 100);
    }

    public OriginalStringCodec(int fixedSize, int maxSize) {
    ...
    public static void main(String[] args) {
        OriginalStringCodec bc = new OriginalStringCodec(0, 5000);
