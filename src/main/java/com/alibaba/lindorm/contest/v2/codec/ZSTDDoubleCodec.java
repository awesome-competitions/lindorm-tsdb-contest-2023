...
public class ZSTDDoubleCodec extends Codec<double[]>{

    private final SimpleBDFCMCodec codec = new SimpleBDFCMCodec();
    @Override
    ...
    public static void main(String[] args) {
        ZSTDDoubleCodec varintCodec = new ZSTDDoubleCodec();
        double[][] numbersList = {
        ...
        for (double[] numbers: numbersList){
            ByteBuffer encodedBuffer = ByteBuffer.allocateDirect(3000);
