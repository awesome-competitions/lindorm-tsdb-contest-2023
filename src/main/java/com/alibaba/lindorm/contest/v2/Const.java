...
public interface Const {
    ...
    Map<String, Codec<int[]>> COLUMNS_INTEGER_CODEC = new HashMap<>(COLUMN_COUNT){{
        ...
        put("KFGP", Codec.fixedIntCodec(-18068, -8070));
        put("ZZBE", Codec.fixedIntCodec(-24669, -14671));
        put("HJPZ", Codec.fixedIntCodec(-17916, -12918));
        put("JDOE", Codec.fixedIntCodec(-7653, -5655));
        put("KWET", Codec.fixedIntCodec(17995, 20993));
        put("WNHB", Codec.fixedIntCodec(-22663, -12665));
        put("ENVH", Codec.fixedIntCodec(17190, 1517188));
        put("CSRC", Codec.fixedIntCodec(-8072, 9991926));
        put("GONE", Codec.fixedIntCodec(-21827, 5978171));
        put("BZPV", Codec.fixedIntCodec(2631, 50002629));
